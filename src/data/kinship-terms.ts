...
const NEUTRAL: Partial<Record<RelationshipType, KinshipTerm>> = {
  ...
  [RelationshipType.PATERNAL_UNCLE]:       t('큰아버지', 'keun-abeoji', "father's older brother", "Used when father's brother is older than father. 작은아버지 (jageunabeoji) is used if younger."),
  [RelationshipType.PATERNAL_AUNT]:        t('고모', 'gomo', "father's sister"),
  [RelationshipType.MATERNAL_UNCLE]:       t('외삼촌', 'oe-samchon', "mother's brother"),
  [RelationshipType.MATERNAL_AUNT]:        t('이모', 'imo', "mother's sister"),
  [RelationshipType.SON]:                  t('아들', 'adeul', 'son'),
  [RelationshipType.DAUGHTER]:             t('딸', 'ttal', 'daughter'),
  [RelationshipType.NEPHEW]:               t('조카', 'joka', "sibling's son"),
  [RelationshipType.NIECE]:               t('조카', 'joka', "sibling's daughter", "Same term 조카 is used for both niece and nephew in modern Korean."),
...
const MALE_SPECIFIC: Partial<Record<RelationshipType, KinshipTerm>> = {
  [RelationshipType.OLDER_BROTHER]: t('형', 'hyeong', 'older brother (male speaker)'),
  [RelationshipType.OLDER_SISTER]:  t('누나', 'nuna', 'older sister (male speaker)'),
  [RelationshipType.SPOUSE]:        t('아내', 'anae', 'wife'),
  [RelationshipType.PATERNAL_COUSIN_MALE_OLDER]:   t('형', 'hyeong', 'older male paternal cousin (male speaker)'),
  [RelationshipType.PATERNAL_COUSIN_FEMALE_OLDER]: t('누나', 'nuna', 'older female paternal cousin (male speaker)'),
  ...
  [RelationshipType.MATERNAL_COUSIN_MALE_OLDER]:   t('형', 'hyeong', 'older male maternal cousin (male speaker)'),
  [RelationshipType.MATERNAL_COUSIN_FEMALE_OLDER]: t('누나', 'nuna', 'older female maternal cousin (male speaker)'),
...
const FEMALE_SPECIFIC: Partial<Record<RelationshipType, KinshipTerm>> = {
  [RelationshipType.OLDER_BROTHER]: t('오빠', 'oppa', 'older brother (female speaker)'),
  [RelationshipType.OLDER_SISTER]:  t('언니', 'eonni', 'older sister (female speaker)'),
  [RelationshipType.SPOUSE]:        t('남편', 'nampyeon', 'husband'),
  [RelationshipType.PATERNAL_COUSIN_MALE_OLDER]:   t('오빠', 'oppa', 'older male paternal cousin (female speaker)'),
  [RelationshipType.PATERNAL_COUSIN_FEMALE_OLDER]: t('언니', 'eonni', 'older female paternal cousin (female speaker)'),
  [RelationshipType.PATERNAL_COUSIN_MALE_YOUNGER]: t('남동생', 'nam-dongsaeng', 'younger male paternal cousin'),
  [RelationshipType.PATERNAL_COUSIN_FEMALE_YOUNGER]: t('여동생', 'yeo-dongsaeng', 'younger female paternal cousin'),
  [RelationshipType.MATERNAL_COUSIN_MALE_OLDER]:   t('오빠', 'oppa', 'older male maternal cousin (female speaker)'),
  [RelationshipType.MATERNAL_COUSIN_FEMALE_OLDER]: t('언니', 'eonni', 'older female maternal cousin (female speaker)'),
  [RelationshipType.MATERNAL_COUSIN_MALE_YOUNGER]: t('남동생', 'nam-dongsaeng', 'younger male maternal cousin'),
  [RelationshipType.MATERNAL_COUSIN_FEMALE_YOUNGER]: t('여동생', 'yeo-dongsaeng', 'younger female maternal cousin'),
}
